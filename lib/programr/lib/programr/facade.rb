require 'programr/lib/programr/graph_master'
require 'programr/lib/programr/aiml_parser'
require 'programr/lib/programr/history'
require 'programr/lib/programr/utils'


module ProgramR
  class Facade
    attr_accessor :graph_master,:parser
